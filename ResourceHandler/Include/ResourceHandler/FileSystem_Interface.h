...
DECLDIR_RH_C long Destroy_C(ResourceHandler::FileSystem_Interface*, uint32_t guid, uint32_t type);
DECLDIR_RH_C long CreateS_C(ResourceHandler::FileSystem_Interface*, const char* guid, const char* type, void* data, uint64_t size);
...
DECLDIR_RH_C long Exist_C(ResourceHandler::FileSystem_Interface*, uint32_t guid, uint32_t type);
DECLDIR_RH_C long ExistS_C(ResourceHandler::FileSystem_Interface*, const char* guid, const char* type);
DECLDIR_RH_C long ReadS_C(ResourceHandler::FileSystem_Interface*, const char* guid, const char* type, void* data, uint64_t size);
DECLDIR_RH_C long WriteS_C(ResourceHandler::FileSystem_Interface*, const char* guid, const char* type, void* data, uint64_t size);
DECLDIR_RH_C long DestroyS_C(ResourceHandler::FileSystem_Interface*, const char* guid, const char* type);
DECLDIR_RH_C long Defrag_C(ResourceHandler::FileSystem_Interface*);
DECLDIR_RH_C long GetSizeOfFile_C(ResourceHandler::FileSystem_Interface*, uint32_t guid, uint32_t type, uint64_t* size);
DECLDIR_RH_C long GetSizeOfFileS_C(ResourceHandler::FileSystem_Interface*, const char* guid, const char* type, uint64_t* size);
...
DECLDIR_RH_C long GetFiles_C(ResourceHandler::FileSystem_Interface* l,
	ResourceHandler::FILE_C* files,
	uint32_t  numFiles);

DECLDIR_RH_C long GetFile_C(ResourceHandler::FileSystem_Interface* l,
