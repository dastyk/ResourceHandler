...
DECLDIR_RH_C ResourceHandler::File_Error DestroyLoader(ResourceHandler::FileSystem_Interface * l)
{
	auto t = l->Shutdown();
	delete l;
	return t;
...
DECLDIR_RH_C ResourceHandler::File_Error InitLoader_C(ResourceHandler::FileSystem_Interface* loader,const char * filePath, ResourceHandler::Mode mode)
{
	return loader->Init(filePath, mode);
}

DECLDIR_RH_C ResourceHandler::File_Error Read_C(ResourceHandler::FileSystem_Interface * l, uint32_t guid, uint32_t type, void * data, uint64_t  size)
{
	return l->Read(guid, type, { data, size });
}

DECLDIR_RH_C ResourceHandler::File_Error Destroy_C(ResourceHandler::FileSystem_Interface* l, uint32_t guid, uint32_t type)
{
	return l->Destroy(guid, type);
}

DECLDIR_RH_C ResourceHandler::File_Error CreateS_C(ResourceHandler::FileSystem_Interface *l, const char * guid, const char * type, void * data, uint64_t size)
{
...
DECLDIR_RH_C ResourceHandler::File_Error ReadS_C(ResourceHandler::FileSystem_Interface * l, const char * guid, const char * type, void * data, uint64_t  size)
{
	return l->Read(std::string(guid), std::string(type), { data, size });
}

DECLDIR_RH_C ResourceHandler::File_Error WriteS_C(ResourceHandler::FileSystem_Interface *l, const char * guid, const char * type, void * data, uint64_t size)
{
	return l->Write(std::string(guid), std::string(type), { data, size });
}

DECLDIR_RH_C ResourceHandler::File_Error DestroyS_C(ResourceHandler::FileSystem_Interface *l, const char * guid, const char * type)
{
	return l->Destroy(std::string(guid), std::string(type));
}

DECLDIR_RH_C ResourceHandler::File_Error Defrag_C(ResourceHandler::FileSystem_Interface * l)
{
	return l->Defrag();
}

DECLDIR_RH_C ResourceHandler::File_Error GetSizeOfFile_C(ResourceHandler::FileSystem_Interface *l, uint32_t guid, uint32_t type, uint64_t * size)
{
	return l->GetSizeOfFile(guid, type, *size);
}

DECLDIR_RH_C ResourceHandler::File_Error GetSizeOfFileS_C(ResourceHandler::FileSystem_Interface *l, const char * guid, const char * type, uint64_t * size)
{
...
DECLDIR_RH_C ResourceHandler::File_Error GetFiles_C(ResourceHandler::FileSystem_Interface * l, ResourceHandler::FILE_C* files, uint32_t numFiles)
{
	return l->GetFiles(files, numFiles);
}

DECLDIR_RH_C ResourceHandler::File_Error GetFile_C(ResourceHandler::FileSystem_Interface * l, ResourceHandler::FILE_C * file, const char* guid, const char* type)
{
